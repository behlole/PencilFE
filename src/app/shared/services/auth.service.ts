...
export class AuthService {
    ...
    usersRef: AngularFireList<User>;    // Reference to Student data list, its an Observable
    ...
    constructor(
        ...
        this.notes_Firebase_Data = this.afDb.list('User');
    ...
    // Returns true when user is looged in and email is verified
    AddUserRe(user: User) {
        // this.notes_Firebase_Data.update(user.email.replace(/[^\w\s]/gi, '').toLowerCase(),{  
        //     UserID: user.uid,
        //     Email: user.email,
